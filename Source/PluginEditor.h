...
struct FFTDataGenerator {
    ...
    void produceFFTDataForRedering(const juce::AudioBuffer<float>& audioData, const float negativeInfinity) {
...
//structure inheriting from the slider class
